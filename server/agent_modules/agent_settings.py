...
# Pinecone
pinecone_db = Pinecone.from_existing_index(embedding=embeddings)
...
Ethan_retriever = AgentRetriever(name = "Ethan", vectorstore = pinecone_db)
...
Jack_retriever = AgentRetriever(name = "Jack", vectorstore = pinecone_db)
...
Oliver_retriever = AgentRetriever(name = "Oliver", vectorstore = pinecone_db)
...
Lily_retriever = AgentRetriever(name = "Lily", vectorstore = pinecone_db)
